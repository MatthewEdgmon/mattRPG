...
OverworldPlayer::OverworldPlayer(std::vector<std::string> animations) {

}

void OverworldPlayer::ChangeState(OverworldPlayerState state) {



}

std::string OverworldPlayer::GetAnimationFrame() {
