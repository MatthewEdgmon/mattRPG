...
MusicTrack::MusicTrack() : track_time(0.0f) {

}

void MusicTrack::Generate(std::uint8_t* data) {

}

void MusicTrack::Delete() {

}

void MusicTrack::FadeIn(float fade_speed) {

}

void MusicTrack::FadeOut(float fade_speed) {

}

void MusicTrack::Play(float track_time) {
